...
useless, since there is now way for these downstream tasks to distinguish 
...
users start by calling findDEG which returns a dataframe of differential 
...
## References
Hoffman, P. (2021) Introduction to scRNA-seq. integration https://satijalab.org/seurat/articles/integration_introduction.html
